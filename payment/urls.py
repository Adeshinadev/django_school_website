...
urlpatterns = [
    ...
    path('paymentsearch', views.paymentsearch, name='paymentsearch'),
    path('finalpayments', views.finalpayments, name='finalpayments'),
    path('paymentreceipt', views.paymentreceipt, name='paymentreceipt'),
    path('calculations', views.calculations, name='calculations'),
    path('paymenteval', views.paymenteval, name='paymenteval'),
]
